...
public class PanelSoldado extends JPanel implements Observer
{
    ...
    public PanelSoldado(Soldado soldado)
    {
	...
	if(o==this.soldado) 
	{
	    this.textArea.append(this.soldado.getNombre()+"   "+arg+"\n");
	}
